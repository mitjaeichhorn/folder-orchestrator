...
import { isFree, FREE_ROW_CLASS } from '../shared/cost'
import { sessionLabel } from '../sessions/session-color'
import { LineBadge } from '../shared/LineBadge'
import { AlertDot } from '../propositions/AlertDot'
import type { Alert } from '../propositions/alerts'
import { gapPx, fmtGap, isCapped, isRunning, runningFor, isStalled } from '../shared/timeline'
