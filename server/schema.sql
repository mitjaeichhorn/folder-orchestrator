...
CREATE TABLE IF NOT EXISTS sessions (
  ...
  entrypoint TEXT,
  version    TEXT,
  -- Claude Code's own name for the session, written as an `ai-title` record.
  -- Generated by a model UPSTREAM, before this app ever saw the file: reading a
  -- stored field is not running one. Same precedent as the Bash `description`.
  ai_title   TEXT,
